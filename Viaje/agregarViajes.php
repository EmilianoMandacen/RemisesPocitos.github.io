...
?>
    <form method="POST" action="guardarV.php">
        <div class="contenedor1">
            <div class="card3">
                ...
                <br><br>
                <input type="text" name="origen" id="origen" class="input1" placeholder="Origen..." maxlength="20"
                    required />
                <br><br>
                <label class="lebel" title="destino">Destino del viaje</label>
                <br><br>
                <input type="text" name="destino" id="destino" class="input1" maxlength="20" placeholder="Destino..."
                    required />
                <br><br>
                <label class="lebel" title="comentario">Comentario</label>
                <br><br>
                <input type="text" name="comentario" id="comentario" class="input1" placeholder="Comentario..."
                    maxlength="20" required />
                <br><br>
                <label class="lebel" title="costo">Costo del viaje</label>
                <br><br>
                <input type="text" name="costo" id="costo" class="input1" maxlength="6" placeholder="Costo..." required
                    oninput="validarNumero(this);" />
                <br><br>
                <label class="lebel" title="fecha">Fecha del viaje</label>
                <br><br>
                <input type="date" name="fecha" id="fecha" class="input1" required />
                <br><br>
                <label class="lebel" title="hora">Hora del viaje</label>
                <br><br>
                <input type="time" name="hora" id="hora" class="input1" required />
                <br><br>
            </div>
            <div class="card3">
                <br><br><br>
    ...
    ?>
                ...
                <br><br>
                <input type="text" name="Nombre" id="Nombre" class="input1" maxlength="30" placeholder="Nombre..."
                    required />
                <br><br>
                <label class="lebel" title="apellido">Apellido</label>
                <br><br>
                <input type="text" name="Apellido" id="Apellido" class="input1" placeholder="Apellido..." maxlength="20"
                    required />
                <br><br>
                <label class="lebel" title="telefono">Teléfono</label>
                <br><br>
                <input type="text" name="tel" id="tel" class="input1" oninput="formatoTelefono(this)" maxlength="11"
                    placeholder="Teléfono..." required />
            </div>

            <button type="button" id="save" class="btn20" title="Agregar"> Agregar Viaje</button>
            <a href="ver_Viajes.php" style="text-decoration: none; color: black;">
                <div class="btn21"> Ver Viajes</div>
            </a>
        </div>
    </form>
...
function mostrarCampos() {
    ...
    var rutSelect = document.getElementById("RUT");
