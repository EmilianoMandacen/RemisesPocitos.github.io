...
?>
    ...
    <div class="filtro1">
        <label for="filtrar" class="txt5">Ordenar por:</label>
        <select name="Filtro" id="filtrar" style="background-color: #ACACAD;">
        <option value="lista_negra" selected>Lista negra</option>
            <option value="RUT">Rut</option>
            <option value="nom_ficticio">Nombre</option>
        </select>
    </div>
    <br><br><br><br>
    <div class="card2">
        <table class="content-table">
            <thead>
                <tr class="txt4">
                    ...
                    <th class="th" style="background-color: #ACACAD;">Razón Social</th>
        ...
        <br>
        <a href="agregarCli.php" style="text-decoration: none; color: black;"><button class="btn12">Agregar un cliente
            </button></a>
