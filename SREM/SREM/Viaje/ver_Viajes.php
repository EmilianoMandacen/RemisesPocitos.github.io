...
?>
    ...
    <div class="filtro">
        ...
        <option value="cod_reserva" selected>Codigo</option>
    ...
    <div class="card2">
        ...
        <br>
         <a href="agregarViajes.php" style="text-decoration: none; color: black;" ><button class="btn12">Agregar un Viaje </button></a>
