...
?>
    ...
    <div class="filtro1">
        ...
        <option value="c_pasajeros" >Pasajeros</option>
        </select>
    </div>
    <br><br><br><br>
    <div class="card2">
        ...
        <br>
         <a href="../Chofer/agregarChofer.php" style="text-decoration: none; color: black;" ><button class="btn12">Agregar un Coche </button></a>
